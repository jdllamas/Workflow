						...
						<ul class="nav navbar-nav">
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="{{ url('/role') }}">Listado de Roles</a></li>
									<li><a href="{{ url('/role/create') }}">Nuevo Rol</a></li>
								</ul>
							</li>
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="{{ url('/permission') }}">Listado de Permisos</a></li>
									<li><a href="{{ url('/permission/create') }}">Nuevo Permiso</a></li>									
								</ul>
							</li>
						</ul>
					@endif
